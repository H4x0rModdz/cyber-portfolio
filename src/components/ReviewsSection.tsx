...
const reviews: IReview[] = [
  {
    ...
    text: "User didn't leave a comment, but their rating speaks for itself!",
    img: '/images/pedro.jpg',
    rating: 5,
  },
  {
    id: 2,
    name: 'Seringueiro Client',
    text: "User didn't leave a comment, but their rating speaks for itself!",
    img: '/images/seringueiro.png',
    rating: 5,
  },
  {
    id: 3,
    name: 'Personalisec Client',
    text: "User didn't leave a comment, but their rating speaks for itself!",
    img: '/images/personalisec.png',
    rating: 5,
  },
  {
    id: 4,
  ...
  },
  {
    ...
    name: 'PayCoin Client',
    text: "User didn't leave a comment, but their rating speaks for itself!",
    img: '/images/paycoin.png',
    rating: 5,
  },
  {
    id: 6,
    name: 'OwProduct Client',
    text: "User didn't leave a comment, but their rating speaks for itself!",
    img: '/images/owproduct.png',
    rating: 5,
  },
  {
    id: 7,
    name: 'BetGo Client',
    text: "User didn't leave a comment, but their rating speaks for itself!",
    img: '/images/betgo.png',
    rating: 5,
  },
  {
    id: 8,
    name: 'BloxTrade Client',
    text: "User didn't leave a comment, but their rating speaks for itself!",
    rating: 5,
  },
  {
    id: 9,
    name: 'LizeLoca Client',
    text: "User didn't leave a comment, but their rating speaks for itself!",
    img: '/images/lizeloca.png',
    rating: 5,
  },
];
...
const ReviewsSection: React.FC = () => {      
    return (
        <div className="text-white py-12 px-4 mb-10">
          <h2 className="text-center text-3xl font-bold mb-8">What My Clients and Peers Say About Me</h2>
          <div className="max-w-6xl mx-auto">
            <div className="w-full max-w-xs sm:max-w-md md:max-w-lg xl:max-w-4xl mx-auto">
              <Slider {...sliderSettings}>
                {reviews.map((review) => (
                  <div key={review.id} className="px-2">
                    <div className="bg-neutral-950 rounded-lg shadow-md pt-12 pb-6 px-6 relative overflow-visible h-full flex flex-col">
                      ...
                      <div className="mt-8 text-center flex-grow flex flex-col">
                        ...
                        <p className="mt-2 text-neutral-300 flex-grow">{review.text}</p>
